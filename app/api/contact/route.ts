  ...
  if (request.method === "POST") {
    ...
    try {
      ...
      await transporter.sendMail({
        ...mailOptions,
        subject: `New Contact Form Submission - ${body.subject || "DAMSA"}`,
        html: `
      <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif; line-height: 1.6;">
  
        <div style="background-color: #E0F2FE; border-left: 4px solid #0A1128; padding: 15px; margin-bottom: 20px;">
          <h2 style="color: #0A1128; margin: 0 0 15px 0;">New Contact Form Submission</h2>
        ...
        html: `
          <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif; line-height: 1.6;">
            ...
            <div style="background-color: white; border-radius: 8px; box-shadow: 0 4px 15px rgba(10,17,40,0.12); padding: 30px; margin-bottom: 30px; border-top: 5px solid #0A1128;">
              ...
              <p style="color: #374151;">Thanks for reaching out to DAMSA. We're grateful for your interest and support. Our team has received your message and will respond within 24–48 hours.</p>
